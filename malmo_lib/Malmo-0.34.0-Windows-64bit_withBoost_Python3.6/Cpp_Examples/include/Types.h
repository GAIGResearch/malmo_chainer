...
#ifndef C__DEV_MALMO_PY3_CLEAN_SCHEMAS_TYPES_H
#define C__DEV_MALMO_PY3_CLEAN_SCHEMAS_TYPES_H
...
namespace malmo
{
  namespace schemas
  {
    ...
    class SignType: public ::xml_schema::string
    {
      public:
      enum value
      {
      ...
      SignType (const char* v);

      SignType (const ::std::string& v);

      SignType (const ::xml_schema::string& v);

      SignType (const ::xercesc::DOMElement& e,
                ::xml_schema::flags f = 0,
                ::xml_schema::container* c = 0);

      SignType (const ::xercesc::DOMAttr& a,
                ::xml_schema::flags f = 0,
                ::xml_schema::container* c = 0);

      SignType (const ::std::string& s,
                const ::xercesc::DOMElement* e,
                ::xml_schema::flags f = 0,
                ::xml_schema::container* c = 0);

      SignType (const SignType& x,
                ::xml_schema::flags f = 0,
                ::xml_schema::container* c = 0);
      ...
      operator value () const
      {
        return _xsd_SignType_convert ();
      }

      protected:
      value
      _xsd_SignType_convert () const;

      public:
      static const char* const _xsd_SignType_literals_[2];
      static const value _xsd_SignType_indexes_[2];
    };
...
namespace malmo
{
  namespace schemas
  {
    ...
    void
    operator<< (::xercesc::DOMElement&, const SignType&);

    void
    operator<< (::xercesc::DOMAttr&, const SignType&);
...
#endif // C__DEV_MALMO_PY3_CLEAN_SCHEMAS_TYPES_H
