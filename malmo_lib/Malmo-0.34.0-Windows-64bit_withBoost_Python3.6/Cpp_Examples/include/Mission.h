...
#ifndef C__DEV_MALMO_PY3_CLEAN_SCHEMAS_MISSION_H
#define C__DEV_MALMO_PY3_CLEAN_SCHEMAS_MISSION_H
...
namespace malmo
{
  namespace schemas
  {
    ...
    class AgentHandlers: public ::xml_schema::type
    {
      ...
      //
      typedef ::malmo::schemas::ObservationFromHuman ObservationFromHuman_type;
      typedef ::xsd::cxx::tree::optional< ObservationFromHuman_type > ObservationFromHuman_optional;
      typedef ::xsd::cxx::tree::traits< ObservationFromHuman_type, char > ObservationFromHuman_traits;

      const ObservationFromHuman_optional&
      ObservationFromHuman () const;

      ObservationFromHuman_optional&
      ObservationFromHuman ();

      void
      ObservationFromHuman (const ObservationFromHuman_type& x);

      void
      ObservationFromHuman (const ObservationFromHuman_optional& x);

      void
      ObservationFromHuman (::std::auto_ptr< ObservationFromHuman_type > p);

      // ObservationFromSystem
      //
      typedef ::malmo::schemas::ObservationFromSystem ObservationFromSystem_type;
      typedef ::xsd::cxx::tree::optional< ObservationFromSystem_type > ObservationFromSystem_optional;
      typedef ::xsd::cxx::tree::traits< ObservationFromSystem_type, char > ObservationFromSystem_traits;

      const ObservationFromSystem_optional&
      ObservationFromSystem () const;

      ObservationFromSystem_optional&
      ObservationFromSystem ();

      void
      ObservationFromSystem (const ObservationFromSystem_type& x);

      void
      ObservationFromSystem (const ObservationFromSystem_optional& x);

      void
      ObservationFromSystem (::std::auto_ptr< ObservationFromSystem_type > p);
      ...
      // HumanLevelCommands
      //
      typedef ::malmo::schemas::HumanLevelCommands HumanLevelCommands_type;
      typedef ::xsd::cxx::tree::optional< HumanLevelCommands_type > HumanLevelCommands_optional;
      typedef ::xsd::cxx::tree::traits< HumanLevelCommands_type, char > HumanLevelCommands_traits;

      const HumanLevelCommands_optional&
      HumanLevelCommands () const;

      HumanLevelCommands_optional&
      HumanLevelCommands ();

      void
      HumanLevelCommands (const HumanLevelCommands_type& x);

      void
      HumanLevelCommands (const HumanLevelCommands_optional& x);

      void
      HumanLevelCommands (::std::auto_ptr< HumanLevelCommands_type > p);
      ...
      ObservationFromHuman_optional ObservationFromHuman_;
      ObservationFromSystem_optional ObservationFromSystem_;
      ...
      HumanLevelCommands_optional HumanLevelCommands_;
...
#endif // C__DEV_MALMO_PY3_CLEAN_SCHEMAS_MISSION_H
